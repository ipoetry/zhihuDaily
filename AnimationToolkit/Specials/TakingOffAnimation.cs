...
namespace AnimationToolkit.Animation
{
    public class TakingOffAnimation : AnimationBase
    {
        ...
        public override IAnimation PlayOn(UIElement target, Action continueWith)
        {
            ...
            var scaleXAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, 1.5);
            var scaleYAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, 1.5);
