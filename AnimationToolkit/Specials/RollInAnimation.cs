...
namespace AnimationToolkit.Animation
{
    public class RollInAnimation : AnimationBase
    {
        ...
        public override IAnimation PlayOn(UIElement target, Action continueWith)
        {
            ...
            target.Opacity = 0;
            transform.TranslateX = -Utils.GetPointInParent(target).X - target.RenderSize.Width;
            ...
            var translateXAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, 0);
            var rotateAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, 0);
