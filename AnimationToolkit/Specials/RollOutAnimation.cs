...
namespace AnimationToolkit.Animation
{
    public class RollOutAnimation : AnimationBase
    {
        ...
        public override IAnimation PlayOn(UIElement target, Action continueWith)
        {
            ...
            var translateXAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, Utils.GetPointInParent(target).X + target.RenderSize.Width);
            var rotateAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, 180);
