...
{
    public class ZoomOutDownAnimation : AnimationBase
    {
        public ZoomOutDownAnimation()
        {
        ...
        public override IAnimation PlayOn(UIElement target, Action continueWith)
        {
            ...
            var transformYAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, -30, target.RenderSize.Height + Utils.GetPointInParent(target).Y);
