...
{
    public class SlideOutDownAnimation : AnimationBase
    {
        public SlideOutDownAnimation()
        {
        ...
        public override IAnimation PlayOn(UIElement target, Action continueWith)
        {
            ...
            var translateAnim = Utils.CreateAnimationWithValues(Duration.TotalMilliseconds, Utils.GetPointInParent(target).Y + target.RenderSize.Height);
